...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        public float crouchHeightDecrease = 1.25f;
        ...
        private void Update()
        {
            ...
            if (Input.GetButtonDown("Crouch"))
            {
                if (!isCrouching)
                {
                    m_CharacterController.height /= crouchHeightDecrease;
                    transform.GetComponent<CapsuleCollider>().height = m_CharacterController.height;
                    isCrouching = true;
                }
                else
                {
        ...
        private void FixedUpdate()
        {
            ...
            else
            {
                ...
                //m_MoveDir -= m_CharacterController.transform.right * jumpMovementMultiplier;
            }
